...
const UsuarioAplicacionAjustePerfil = async (req, res) => {
    const { id } = req.params;
    ...
    console.log(resto);
    const usuarioAplicacion = await UsuarioAplicacion.findByIdAndUpdate(id, resto);
    res.json({ usuarioAplicacion })
}
/*
...
export { UsuarioAplicacionGet, UsuarioAplicacionById, UsuarioAplicacionLogin, UsuarioAplicacionRegistro, UsuarioAplicacionAjustePerfil };